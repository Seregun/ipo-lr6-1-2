...
size = [4, 5, 6, 7, 8]  # Исходный список значений для размеров матрицы
rows = random.choice(size) # Число для высоты матрицы в диапазоне от 4 до 8
cols = random.choice(size) # Число для ширины матрицы в диапазоне от 4 до 8
